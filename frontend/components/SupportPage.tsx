        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-pump-card p-6 rounded-xl border border-gray-800 hover:border-blue-500/50 transition-colors group cursor-pointer">
                    ...
                    <p className="text-xs text-gray-400">Learn about bonding curves, Oasis Sapphire, and fair launches.</p>
                </div>
                ...
                <div className="bg-pump-card p-6 rounded-xl border border-gray-800 hover:border-yellow-500/50 transition-colors group cursor-pointer">
                    ...
                    <p className="text-xs text-gray-400">Understanding transaction costs on Oasis Sapphire.</p>
                </div>
            </div>
            ...
            <div className="bg-blue-900/10 border border-blue-500/20 rounded-xl p-6">
                ...
                <code className="bg-black/30 px-3 py-2 rounded text-blue-200 text-sm">support@oasis.astra</code>
            </div>
        </div>
                    ...
                    {messages.map(msg => (
                        <div key={msg.id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                            <div className={`max-w-[80%] p-3 rounded-lg text-sm ${
                                msg.sender === 'user' ? 'bg-pump-accent text-white' : 'bg-gray-800 text-gray-300'
                            }`}>
                                {msg.text}
                            </div>
                        </div>

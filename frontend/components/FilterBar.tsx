  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 mb-6 items-start sm:items-center text-sm">
      ...
      <select
        ...
        className="bg-white dark:bg-pump-card border border-gray-300 dark:border-gray-800 text-gray-900 dark:text-white text-xs rounded p-2 outline-none sm:ml-auto w-full sm:w-auto focus:border-blue-500"
      >

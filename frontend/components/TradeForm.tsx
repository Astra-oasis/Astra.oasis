    ...
    <div className="bg-pump-card border border-gray-800 rounded-lg overflow-hidden shadow-lg">
      ...
      <div className="p-5 space-y-5">
        ...
        <button 
          onClick={handleTrade}
          disabled={loading}
          className={`w-full py-4 rounded-lg text-lg font-black uppercase tracking-widest shadow-lg transition-all transform active:scale-95 flex items-center justify-center gap-2 ${
            mode === 'buy' 

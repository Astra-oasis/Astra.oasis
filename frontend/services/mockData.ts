...
const generatePriceHistory = () => {
  const data = [];
  let price = 0.45; // Base price reference
  for (let i = 0; i < 20; i++) {
...
const ADJECTIVES = ['Based', 'Oasis', 'Sapphire', 'Astra', 'Rose', 'Blue', 'Fast', 'Lazy', 'Rich', 'Sad', 'Happy', 'Doge', 'Pepe', 'Smart'];
...
const generateCoins = (count: number): Coin[] => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    coins.push({
      ...
      name: name,
      ticker: ticker,
      description: `The most decentralized ${noun.toLowerCase()} on the Oasis Sapphire Layer 2 scaling solution.`,
...
export const MOCK_COMMENTS: Comment[] = [
  { id: '1', user: 'RoseMaxi', text: 'Oasis is fast af!', timestamp: '10:00', type: 'chat' },
  { id: '2', user: 'SapphireDev', text: 'Does this scale?', timestamp: '10:01', type: 'chat' },
  { id: '3', user: 'SniperBot', text: '', timestamp: '10:02', type: 'buy', amount: 250 },
];

export const MOCK_TRADES: Trade[] = [
  { type: 'buy', amount: 120, price: 0.45, timestamp: '10:05:01', user: '0x...a9z' },
  { type: 'sell', amount: 50, price: 0.44, timestamp: '10:05:05', user: '0x...k2p' },
  { type: 'buy', amount: 500, price: 0.46, timestamp: '10:05:12', user: '0x...m5m' },
];

        ...
        const result = await query(
            `UPDATE tokens 
             SET marketcap = COALESCE($2, marketcap),
                 ...
                 price_change_4h = COALESCE($6, price_change_4h),
                 price_change_6h = COALESCE($7, price_change_6h),
                 trader_count = COALESCE($8, trader_count),
                 price_snapshot_value = COALESCE($9, price_snapshot_value),
            ...
            [
                ...
                price_change_4h !== undefined ? price_change_4h : null,
